...
def alignlinearmultipulses(Jmax=None, J0=None, m0=None, rotcon=None, centrifugal=None, V00=None, V02=None, t=None,
                           tfree=None, NOPlaser=None, NOPfree=None, fullsize=None, pulsed=None):
    ...
    # Create the <Yl1m|cos^4 theta|Yl2m> matrix: Selection rules: deltaJ=0,2,-2
